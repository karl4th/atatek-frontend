...
"[project]/src/components/auth/address-form.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AddressForm({ className, ...props }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddressForm.useEffect": ()=>{
            const searchAddress = {
                "AddressForm.useEffect.searchAddress": async ()=>{
                    if (query.length < 3) return;
                    setLoading(true);
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`https://api.atatek.kz/address/api/address/?query=${encodeURIComponent(query)}`, {
                            withCredentials: true
                        });
                        setAddresses(response.data.results);
                    } catch (error) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Мекен жайды іздеу кезінде қателік орын алды");
                    } finally{
                        setLoading(false);
                    }
                }
            }["AddressForm.useEffect.searchAddress"];
            const timeoutId = setTimeout(searchAddress, 300);
            return ({
                "AddressForm.useEffect": ()=>clearTimeout(timeoutId)
            })["AddressForm.useEffect"];
        }
    }["AddressForm.useEffect"], [
        query
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!selectedAddress) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Мекен жайды таңдаңыз");
            return;
        }
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`https://api.atatek.kz/auth/set-address?address=${selectedAddress.id}`, {}, {
                withCredentials: true
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Мекен жай сәтті тіркелді");
            router.push("/auth/register/pages");
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Мекен жайды тіркеу кезінде қателік орын алды");
        }
    };
                                                    ...
                                                    children: addresses.map((address)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$command$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CommandItem"], {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__["Check"], {
                                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("mr-2 h-4 w-4", selectedAddress?.id === address.id ? "opacity-100" : "opacity-0")
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/components/auth/address-form.tsx",
                                                                    lineNumber: 128,
                                                                    columnNumber: 45
...
_s(AddressForm, "ubY/VvGLIkgdqzqrtKIggcdGS2g=", false, function() {
    return [
...
//# sourceMappingURL=src_6a2e3569._.js.map