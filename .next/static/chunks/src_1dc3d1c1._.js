...
"[project]/src/contexts/aulet-context.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AuletContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function AuletProvider({ children }) {
    ...
    const [familyTree, setFamilyTree] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const fetchFamilyTree = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useCallback({
        "AuletProvider.useCallback[fetchFamilyTree]": async ()=>{
            try {
                setIsLoading(true);
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/aulet/api/aulet/my`, {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Отбасы ағашын жүктеу кезінде қателік орын алды");
                setFamilyTree([]);
            } finally{
                setIsLoading(false);
            }
        }
    }["AuletProvider.useCallback[fetchFamilyTree]"], []);
    // Создание новой персоны
    const createPerson = async (personData)=>{
        try {
            // Проверяем лимит по тарифу
            if (user?.tariff?.t_family_count && familyTree.length >= user.tariff.t_family_count) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Тарифыңыз бойынша ең көп ${user.tariff.t_family_count} адам қосуға болады`);
                throw new Error('Family count limit exceeded');
            }
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_BASE_URL}/aulet/api/aulet/my/create`, {
                ...personData,
                user_id: user?.id
            }, {
                withCredentials: true
            ...
            if (response.data.status === 'success') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Жаңа тұлға сәтті құрылды");
            ...
            if (error instanceof Error && error.message === 'Family count limit exceeded') {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Тұлға құру кезінде қателік орын алды");
                throw error;
            }
        }
    };
    ...
    const updatePerson = async (personId, personData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${API_BASE_URL}/aulet/api/aulet/my/update/${personId}`, {
                ...personData,
            ...
            if (response.data.status === 'success') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Деректер сәтті жаңартылды");
                await fetchFamilyTree(); // Обновляем дерево
            } else {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Деректерді жаңарту кезінде қателік орын алды");
            throw error;
        }
    };
    // Удаление персоны
    const deletePerson = async (personId)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${API_BASE_URL}/aulet/api/aulet/my/delete/${personId}`, {
                withCredentials: true
            });
            if (response.data.status === 'success') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Тұлға сәтті жойылды");
                await fetchFamilyTree(); // Обновляем дерево
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Тұлғаны жою кезінде қателік орын алды");
            throw error;
        }
    };
    // Добавление супруга
    const addSpouse = async (personId, spouseData)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Жұбай сәтті қосылды");
        } catch (error) {
            console.error('Error adding spouse:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Жұбай қосу кезінде қателік орын алды");
            throw error;
        }
    };
    // Добавление ребенка
    const addChild = async (parentId, otherParentId, childData)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Бала сәтті қосылды");
        } catch (error) {
            console.error('Error adding child:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Бала қосу кезінде қателік орын алды");
            throw error;
        }
    };
    // Обновляем выбранную персону когда меняется ID
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "AuletProvider.useEffect": ()=>{
            if (selectedPersonId && familyTree.length > 0) {
                const person = familyTree.find({
                    "AuletProvider.useEffect.person": (p)=>p.id === selectedPersonId
                }["AuletProvider.useEffect.person"]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuletContext.Provider, {
        value: {
            isDrawerOpen,
            setIsDrawerOpen,
            selectedPersonId,
...
_s(AuletProvider, "QG4rcZ/aFlW62k6Xvxbn9PZcSOg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
function useAulet() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(AuletContext);
    if (context === undefined) {
        throw new Error('useAulet must be used within a AuletProvider');
    }
    return context;
}
_s1(useAulet, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "AuletProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/components/aulet/aulet-family-chart.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$family$2d$chart$2f$dist$2f$family$2d$chart$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/family-chart/dist/family-chart.esm.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$aulet$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/aulet-context.tsx [app-client] (ecmascript)");
...
function AuletFamilyChart({ orientation = "vertical" }) {
    ...
    const { familyTree, isLoading, fetchFamilyTree, setSelectedPersonId, setIsDrawerOpen } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$aulet$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAulet"])();
    // Загружаем данные при монтировании компонента
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuletFamilyChart.useEffect": ()=>{
            fetchFamilyTree();
        }
    }["AuletFamilyChart.useEffect"], [
        fetchFamilyTree
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuletFamilyChart.useEffect": ()=>{
            ...
            if (familyTree.length > 0 && containerRef.current) {
                ...
                }["AuletFamilyChart.useEffect"], 100);
            }
        }
    }["AuletFamilyChart.useEffect"], [
        familyTree
    ...
    const createChart = (data)=>{
        ...
        const f3Chart = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$family$2d$chart$2f$dist$2f$family$2d$chart$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createChart(containerRef.current, dataWithIndex).setTransitionTime(1000).setCardXSpacing(200).setCardYSpacing(250).setSingleParentEmptyCard(true, {
            label: 'ҚОСУ'
        ...
        const f3Card = f3Chart.setCard(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$family$2d$chart$2f$dist$2f$family$2d$chart$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].CardHtml).setCardDisplay([
            [
                "first name",
                "last name"
            ],
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            familyTree.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AuletFamilyChart, "NnRhVNQLX41TqSOXrpaf2hDDP7g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$aulet$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAulet"]
    ];
});
_c = AuletFamilyChart;
var _c;
__turbopack_context__.k.register(_c, "AuletFamilyChart");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function ImageUpload({ value, onChange, placeholder = "Аватар жүктеу", className }) {
    ...
    const handleFileSelect = async (event)=>{
        ...
        try {
            ...
            if (result.success) {
                onChange(result.url);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Сурет сәтті жүктелді');
            } else {
                throw new Error(result.error || 'Жүктеу қатесі');
            }
        } catch (error) {
            console.error('Upload error:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Сурет жүктеу қатесі');
...
_s(ImageUpload, "JG4UWoefsrVCv3gueVHTtEhbXcg=");
_c = ImageUpload;
var _c;
...
"[project]/src/components/aulet/parent-selector-dialog.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ParentSelectorDialog({ open, onOpenChange, parentId, parentGender }) {
    _s();
    const { familyTree, addChild } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$aulet$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAulet"])();
    const [childData, setChildData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        first_name: '',
        last_name: '',
        gender: 'M',
        birthday: '',
    ...
    const handleSave = async ()=>{
        if (!childData.first_name.trim() || !childData.last_name.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Баланың аты-жөні міндетті");
            return;
        }
        try {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                possibleParents.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-2",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Label"], {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: [
                                                ...
                                                possibleParents.map((person)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: person.id,
                                                        children: [
                                        ...
                                        selectedParentId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "mt-2",
                                            children: (()=>{
                                                const selectedPerson = possibleParents.find((p)=>p.id === selectedParentId);
                                                return selectedPerson ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ParentSelectorDialog, "gQxa/xfN+ZPo6pNqacUJ+AJrBrE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$aulet$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAulet"]
    ];
});
_c = ParentSelectorDialog;
var _c;
__turbopack_context__.k.register(_c, "ParentSelectorDialog");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/components/aulet/aulet-person-drawer.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/AuthContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$aulet$2f$parent$2d$selector$2d$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/aulet/parent-selector-dialog.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function AuletPersonDrawer() {
    _s();
    const { isDrawerOpen, setIsDrawerOpen, selectedPerson, selectedPersonId, familyTree, createPerson, updatePerson, deletePerson, addSpouse, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$aulet$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAulet"])();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [formRels, setFormRels] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        spouses: [],
        children: [],
        father: null,
        mother: null
    ...
    const [isSubmitting, setIsSubmitting] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [dialogMode, setDialogMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('none');
    const [spouseFormData, setSpouseFormData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        first_name: '',
        last_name: '',
        gender: 'F',
        birthday: '',
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuletPersonDrawer.useEffect": ()=>{
            if (selectedPerson) {
                ...
                setFormRels({
                    spouses: selectedPerson.rels.spouses.map({
                        "AuletPersonDrawer.useEffect": (id)=>parseInt(id)
                    }["AuletPersonDrawer.useEffect"]),
                    children: selectedPerson.rels.children.map({
                        "AuletPersonDrawer.useEffect": (id)=>parseInt(id)
                    }["AuletPersonDrawer.useEffect"]),
                    father: null,
                    mother: null
    ...
    const handleSave = async ()=>{
        if (!formData.first_name.trim() || !formData.last_name.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Аты-жөні міндетті");
            return;
        }
        if (!user?.id) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Пайдаланушы анықталмады");
            return;
        }
        try {
            setIsSubmitting(true);
    ...
    const handleAddSpouse = async ()=>{
        if (!selectedPersonId || !spouseFormData.first_name.trim() || !spouseFormData.last_name.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Жұбайдың аты-жөні міндетті");
            return;
        }
        try {
            setIsSubmitting(true);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$drawer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Drawer"], {
        ...
        children: [
            ...
            selectedPerson && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$aulet$2f$parent$2d$selector$2d$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ParentSelectorDialog"], {
...
_s(AuletPersonDrawer, "g53TyD9uNsWISULYOrdPfSBahis=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$aulet$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAulet"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
_c = AuletPersonDrawer;
var _c;
__turbopack_context__.k.register(_c, "AuletPersonDrawer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/menin-auletim/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$aulet$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/aulet-context.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$aulet$2f$aulet$2d$family$2d$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/aulet/aulet-family-chart.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$aulet$2f$aulet$2d$person$2d$drawer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/aulet/aulet-person-drawer.tsx [app-client] (ecmascript)");
...
function AuletContent() {
    ...
    const { isDrawerOpen, setIsDrawerOpen, fetchFamilyTree, familyTree } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$aulet$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAulet"])();
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$aulet$2f$aulet$2d$family$2d$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuletFamilyChart"], {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$aulet$2f$aulet$2d$person$2d$drawer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuletPersonDrawer"], {}, void 0, false, {
                        fileName: "[project]/src/app/menin-auletim/page.tsx",
                        lineNumber: 136,
                        columnNumber: 9
                    }, this)
...
_s(AuletContent, "IiKLOTrCA2rcPgXCdXdP/r7Pnzg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$aulet$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAulet"]
    ];
});
...
function MeninAuletimPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$aulet$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuletProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuletContent, {}, void 0, false, {
            fileName: "[project]/src/app/menin-auletim/page.tsx",
            lineNumber: 145,
            columnNumber: 7
        }, this)
...
_c1 = MeninAuletimPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "AuletContent");
__turbopack_context__.k.register(_c1, "MeninAuletimPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_1dc3d1c1._.js.map