...
"[project]/src/components/auth/verify-form.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function VerifyForm({ className, ...props }) {
    ...
    const handleSubmit = (e)=>{
        ...
        if (otpValue.length !== 6) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Кодты толық енгізіңіз");
            return;
        }
        if (otpValue === "000111") {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Код дұрыс! Сізді бас бетке бағыттаймыз.");
            setTimeout(()=>{
                router.push("/");
            }, 1000);
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Код дұрыс емес. Қайтадан көріңіз.");
        }
    };
...
_s(VerifyForm, "X9Qo+WqbaVd4yhGav0Ifb+8e3Ek=", false, function() {
    return [
...
_c = VerifyForm;
var _c;
__turbopack_context__.k.register(_c, "VerifyForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_35015681._.js.map