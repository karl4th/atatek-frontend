...
const AuthProvider = ({ children })=>{
    ...
    const login = async (phone, password)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('https://api.atatek.kz/auth/login', {
                phone,
                password
            }, {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"])("Телефон номеріңіз немесе құпия сөзіңіз қате");
            return false;
        }
    };
    const checkAuth = async ()=>{
        setLoading(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('https://api.atatek.kz/auth/get-me', {
                withCredentials: true
            });
    ...
    const getPage = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`https://api.atatek.kz/auth/my-page`, {
                withCredentials: true
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__269b8719._.js.map